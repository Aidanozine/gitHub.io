...
function displayTotal() {
  document.getElementById("total").innerHTML = "Your total amount due is " + totalOrderAmt;
}
...
function display_all() {
  ...
  myTable +=
    "<th style='width: 100px; color: red; text-align: right;'>Total Order Amnt</th>";
  ...
  myTable +=
    "<td><button onclick='displayTotal(" +
    i +
    ")'>Checkout</button></td></table>";
